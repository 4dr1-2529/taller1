/** Normaliza nombres de variables mal configurados en Railway (español / plugins). */
...
export function applyEnvAliases(env: NodeJS.ProcessEnv): void {
...
export function validateRailwayEnv(env: NodeJS.ProcessEnv): string | null {
  applyEnvAliases(env);
