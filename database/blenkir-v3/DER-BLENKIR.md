...
| Rol | Email | Password |
|-----|-------|----------|
| Director | cuenta demo configurada por entorno | DEMO_PASSWORD |
| Profesores | cuentas demo configuradas por entorno | DEMO_PASSWORD |
| Estudiantes | cuentas demo configuradas por entorno | DEMO_PASSWORD |
