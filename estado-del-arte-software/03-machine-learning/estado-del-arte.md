...
`StudentPredictionView` y rutas `/predictions` del backend consumen el endpoint ML con el vector de 7 features. El artículo respalda el flujo completo: entrenamiento offline → modelo serializado → inferencia online para intervención temprana.
