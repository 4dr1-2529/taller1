...
Con `passthrough=False`, **no** recibe las 7 features originales — solo las salidas de los estimadores base (probabilidades o clases según configuración sklearn 1.6).
