...
No ejecutar scripts de población legacy. El seed de estructura no crea los futuros 200 estudiantes. Revisar las cuentas históricas antes de habilitarlas: la migración histórica de contraseñas comunes no constituye una política válida para cuentas nuevas.
